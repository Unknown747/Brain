...
/**
 * Tampilkan progress blok dengan progress bar, kecepatan, dan ETA.
 * @param {number} block     - Nomor blok saat ini (1-based).
 * @param {number} total     - Total blok.
 * @param {number} candidates - Jumlah kandidat di blok ini.
 * @param {number} fresh     - Jumlah alamat baru yang dicek di blok ini.
 * @param {number} foundCount - Total temuan kumulatif.
 * @param {string} elapsed   - Durasi blok ini (detik).
 * @param {number} speed     - Kecepatan pengecekan (alamat/detik).
 * @param {string} eta       - Perkiraan waktu tersisa.
 */
