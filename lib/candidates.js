 ...
 * @param {Set<string>} [opts.seen]  Set "sudah dilihat" yang dibagi antar
 *   pemanggilan — kalau diberikan, varian yang sudah pernah keluar di blok
 *   sebelumnya tidak akan diproses ulang.
 */
function generateVariants(items, opts = {}) {
    ...
    // Catat berapa varian yang di-skip karena duplikat (dipakai di ringkasan).
